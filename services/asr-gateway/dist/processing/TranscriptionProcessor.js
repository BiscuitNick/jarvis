...
class TranscriptionProcessor extends node_events_1.EventEmitter {
    constructor(config = {}) {
        super();
     ...
     */
    processResult(sessionId, result, provider) {
     ...
     */
    getCompleteTranscript(sessionId) {
        const session = this.sessions.get(sessionId);
        if (!session) {
            return null;
        }
     ...
     */
    normalizeProviderResult(rawResult, provider) {
        switch (provider) {
            case 'aws':
     ...
     */
    normalizeDeepgramResult(result) {
...
//# sourceMappingURL=TranscriptionProcessor.js.map